package com.d121211069.submissionandroidexpert.core.ui
...
import com.d121211069.core.databinding.ItemFilmBinding
    ...
    class MyViewHolder(val binding: ItemFilmBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(item: Film) {
            ...
            itemView.setOnClickListener {
                val intent = Intent(
                    itemView.context,
                    Class.forName("com.d121211069.submissionandroidexpert.ui.detail.DetailActivity")
                )
